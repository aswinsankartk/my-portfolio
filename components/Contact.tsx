...
export default function Contact() {
  return (
    ...
    >
      ...
      <p className="lg:text-xl md:text-xl lg:pl-6 lg:w-130 w-72 font-manrope text-md font-extrabold mt-7 leading-relaxed">
      ...
      <Image
        ...
        className="overflow-hidden absolute bottom-0 -right-26 w-[95%] z-5 pointer-events-none md:w-[70%] md:right-4 lg:w-[40%] lg:right-30"
      />
    </section>
  );
}
